import React, { FC, useMemo, useState, useRef, useEffect } from "react"; // Import React
import {
  Card,
  CardBody,
  VStack,
      ...
      <CardBody>
        <VStack align="stretch" spacing={3}>
          ...
          <HStack justify="space-between" align="center" mt="auto">
            <Tooltip
              label={
                votes.length > 0 ? `Votes: ${votes.join(", ")}` : "No votes yet"
              }
              placement="top"
            >
              <Button
...
export default React.memo(RetroCard); // Memoize the component
