...
interface JoinRetroBoardModalProps {
  ...
  hasPassword?: boolean;
  initialName?: string | null; // Optional initial name
  isNameDisabled?: boolean; // Optional flag to disable name input
}
...
const JoinRetroBoardModal: FC<JoinRetroBoardModalProps> = ({
  ...
  onJoin,
  hasPassword,
  initialName = null, // Default to null
  ...
  // Set initial name from props or localStorage
  useEffect(() => {
    if (initialName) {
      setName(initialName);
    } else {
  ...
  }, [initialName]); // Rerun if initialName changes
          ...
          <VStack spacing={4}>
            <FormControl isRequired>
              ...
              <Input
                ...
                isDisabled={isNameDisabled} // Disable if needed
                onKeyPress={(e) => {
