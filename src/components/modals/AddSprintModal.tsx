                                ...
                                <FormControl isInvalid={!!formErrors.sprintName}>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => {
                                            ...
                                            setFormErrors(prev => ({ ...prev, sprintName: undefined }))
                                        }}
                                ...
                                <FormControl isInvalid={!!formErrors.committedPoints}>
                                    ...
                                    <NumberInput
                                        ...
                                        onChange={(value) => {
                                            ...
                                            setFormErrors(prev => ({ ...prev, committedPoints: undefined }))
                                        }}
                                    >
                                        <NumberInputField placeholder="Enter points" />
                                    </NumberInput>
                                    <FormErrorMessage>{formErrors.committedPoints}</FormErrorMessage>
                                </FormControl>
                            </GridItem>
                            <GridItem>
                                <FormControl isInvalid={!!formErrors.completedPoints}>
                                    ...
                                    <NumberInput
                                        ...
                                        onChange={(value) => {
                                            ...
                                            setFormErrors(prev => ({ ...prev, completedPoints: undefined }))
                                        }}
                                    >
                                        <NumberInputField placeholder="Enter points" />
                                    </NumberInput>
                                    <FormErrorMessage>{formErrors.completedPoints}</FormErrorMessage>
                                </FormControl>
                            </GridItem>
                        </Grid>
                    </VStack>
